...
exports.decorateDatabaseConnectionError = decorateDatabaseConnectionError;
...
function buildSupabaseIpv6Hint(connectionUrl) {
    let hostname = '';
    try {
...
function decorateDatabaseConnectionError(error, connectionUrl) {
