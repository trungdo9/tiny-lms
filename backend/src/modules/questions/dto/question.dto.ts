...
import { Difficulty, DIFFICULTY_VALUES } from '../../../common/enums/difficulty.enum';

export const VALID_QUESTION_TYPES = ['single', 'multi', 'true_false', 'short_answer', 'essay', 'matching', 'ordering', 'cloze'];
export const VALID_DIFFICULTIES = DIFFICULTY_VALUES;
...
export class CreateQuestionDto {
  ...
  @ApiPropertyOptional({ enum: VALID_DIFFICULTIES, default: Difficulty.NORMAL, description: 'Difficulty level' })
